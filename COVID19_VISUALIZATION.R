...
g1 <- time %>% 
  ...
  geom_label_repel(aes(label=ifelse(date==as.POSIXct("2020-03-11") & accumulation>7500 & type == "confirmed", "Overlapped! Lets scale y axis", "")),
...
b <- patient_info %>% 
  ...
  labs(x="Age", y="", 
       title="Distribution within treated_group per age") +
  theme_fivethirtyeight() + 
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 16),
        plot.subtitle = element_text(hjust = 0.5, face = "bold", size = 13),
        axis.text.x = element_text(size = 12, face = "bold")) 
...
c <- patient_info %>% 
  ...
  scale_fill_brewer(palette='Set2') +
  labs(x="Sex", y="", 
       title="Distribution within treated_group per sex") +
  theme_fivethirtyeight() + 
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 16),
        plot.subtitle = element_text(hjust = 0.5, face = "bold", size = 13),
        axis.text.x = element_text(size = 12, face = "bold")) 
